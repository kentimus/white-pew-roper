 ...
 * @author kent roper
 */
public class SaveAuthorsView extends ViewBase {

    /**
     * Constructor
     */
    public SaveAuthorsView() {
        super();
    }
    ...
    public boolean doAction(String[] inputs) {
        ...
        authorsReport(fileName);

        return false;
    }

    private void authorsReport(String fileName) {
        try {
            FileAuthorsView view = new FileAuthorsView();
